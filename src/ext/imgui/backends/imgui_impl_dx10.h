...
//  [X] Renderer: User texture binding. Use 'ID3D10ShaderResourceView*' as texture identifier. Read the FAQ about
...
//  (ImGuiBackendFlags_RendererHasTextures). [X] Renderer: Multi-viewport support (multiple windows). Enable with
