...
//  [X] Renderer: User texture binding. Use 'LPDIRECT3DTEXTURE9' as texture identifier. Read the FAQ about
...
//  (ImGuiBackendFlags_RendererHasTextures). [X] Renderer: IMGUI_USE_BGRA_PACKED_COLOR support, as this is the optimal
//  color encoding for DirectX9. [X] Renderer: Multi-viewport support (multiple windows). Enable with 'io.ConfigFlags |=
