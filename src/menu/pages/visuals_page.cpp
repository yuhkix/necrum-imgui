...

{
	...
	dl->AddLine(ImVec2(l_shoulder_x, shoulder_y), ImVec2(l_elbow_x, l_elbow_y), styled(IM_COL32(48, 48, 54, 230)), 4.5f);
	...
	dl->AddLine(ImVec2(r_shoulder_x, shoulder_y), ImVec2(r_elbow_x, r_elbow_y), styled(IM_COL32(48, 48, 54, 230)), 4.5f);
...

	{
		...
		pos.x = std::clamp(pos.x, preview_x + pad, preview_x + preview_w - pad);

		pos.y = std::clamp(pos.y, preview_y + pad, preview_y + preview_h - pad);
